...
class UIPixiHandler {
	...
	static createMapCharacterArray () {
	...
	static displayStatBars (healthVal) {
	...
	static setupPageUI() {
		UIPageChatController.clearMessageLog();
		UIPageChatController.hidePasswordInput();
